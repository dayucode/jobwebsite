layui.define(['layer', 'table','restClient'], function (exports) {
    var $ = layui.jquery;
        ...
        render: function (param) {
            ...
            if (param.data) {
                ...
                if(param.method === 'post' || param.method === 'POST') {
                    restClient.post(param.url, param.where, function(res){
                        if(param.parseData){
                    ...
                    restClient.get(param.url, param.where, function(res){
                        if(param.parseData){
                            res = param.parseData(res);
                            param.data = res.data;
                        }
