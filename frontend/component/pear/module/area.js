layui.define(['layer', 'form', 'laytpl'], function (exports) {
    ...
    Class.prototype.events = function (reload = false) {
        ...
        form.on('select(' + provinceFilter + ')', function (data) {
            ...
            options.data.province = getValue('province', data.value, options.data.provinceCode);
        ...
        form.on('select(' + cityFilter + ')', function (data) {
            ...
            if (options.data.provinceCode) {
                options.data.city = getValue('city', data.value, options.data.provinceCode.slice(0, 2));
        ...
        form.on('select(' + countyFilter + ')', function (data) {
            ...
            if (options.data.cityCode) {
                options.data.county = getValue('county', data.value, options.data.cityCode.slice(0, 4));
            }
            options.change(options.data);
        });
    ...
    function getValue(type, code, parentCode = 0) {
        let name = '';
        let list = areaList[type + "_list"] || {};
        let result = {};
        Object.keys(list).map(function (_code) {
