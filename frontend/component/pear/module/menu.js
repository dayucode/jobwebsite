layui.define(['table', 'jquery', 'element','restClient','yaml'], function (exports) {
	"use strict";
	...
	function getData(url) {
		var defer = $.Deferred();
		restClient.get(url,{async:false},function(data){
			defer.resolve(data)
		});
	...
	function postData(url) {
		var defer = $.Deferred();
		restClient.post(url,{async:false},function(data){
			defer.resolve(data)
		});
		return defer.promise();
	}
