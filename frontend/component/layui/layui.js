...
!function (t) {
    ...
    r.digit = function (t, e, n) {
        ...
        t = t || {};
        var e = r.elem("style"), n = t.text || "", o = t.target || r("body")[0];
        if (n) {
            ...
            var i = e.id = "LAY-STYLE-" + (t.id || "DF-" + r.style.index), c = r(o).find("#" + i);
        ...
        return t ? e.each(function (e, n) {
            var o = n.value, i = "string" == typeof r(n).attr("readonly");
            if ("number" != typeof n.selectionStart || i) n.value = "", n.focus(), n.value = o + t; else {
                var c = n.selectionStart, u = n.selectionEnd, a = [o.substring(0, c), t, o.substr(u)];
        ...
        return t.each(function (t, e) {
            var n = e.value, o = "string" == typeof r(e).attr("readonly");
            if ("number" != typeof e.selectionStart || o) e.value = "", e.focus(), e.value = n.replace(/[\s\S]{1}$/, ""); else {
                var i = e.selectionStart, c = e.selectionEnd, u = i - (i == c ? 1 : 0),
...
layui.define(function (e) {
    "use strict";
    var a = document, t = "getElementById", n = "getElementsByTagName", r = "laypage", i = "layui-disabled",
        u = function (e) {
            var a = this;
    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, r = {
            prev: function () {
            ...
            page: function () {
                ...
                var r = Math.floor((t - 1) / 2), i = n > 1 ? a.curr - r : 1, u = n > 1 ? function () {
                    var e = a.curr + (t - r - 1);
        ...
        if (e) {
            var t = this, r = t.config, i = e.children, u = e[n]("button")[0], l = e[n]("input")[0],
        ...
        if (e) {
            ...
            t && s.on(t, "keyup", function (t) {
                var n = this.value, r = t.keyCode;
                /^(37|38|39|40)$/.test(r) || (/\D/.test(n) && (this.value = n.replace(/\D/, "")), 13 === r && a.jump(e, !0))
            })
        }
    }, u.prototype.render = function (e) {
        var n = this, r = n.config, i = n.type(), u = n.view(), s = null;
...
!function (e, t) {
    ...
    var a = e.layui && layui.define, n = {
        ...
        }, s = "laydate", o = ".layui-laydate", y = "layui-this", d = "laydate-disabled", m = [100, 2e5],
        c = "layui-laydate-static", u = "layui-laydate-list", h = "laydate-now", f = "laydate-selected",
        p = "layui-laydate-hint", g = "laydate-day-prev", v = "laydate-day-next", D = "layui-laydate-footer",
        T = ".laydate-btns-confirm", w = "laydate-time-text", x = "laydate-btns-time", C = function (e) {
            var t = this;
    ...
    r.formatArr = function (e) {
        ...
        a.elem = lay(a.elem), a.eventElem = lay(a.eventElem), a.elem[0] && (t.rangeStr = a.range ? "string" == typeof a.range ? a.range : "-" : "", "array" === layui._typeof(a.range) && (t.rangeElem = [lay(a.range[0]), lay(a.range[1])]), i[a.type] || (e.console && console.error && console.error("laydate type error:'" + a.type + "' is not supported"), a.type = "date"), a.format === i.date && (a.format = i[a.type] || i.date), t.format = r.formatArr(a.format), t.EXP_IF = "", t.EXP_SPLIT = "", lay.each(t.format, function (e, a) {
            ...
            if ("number" == typeof a[t]) {
                var l = a[t], r = (new Date).getTime(), s = 864e5, o = new Date(l ? l < s ? r + l * s : l : r);
        ...
        var e = this, a = e.config, n = e.lang(), i = "static" === a.position, r = e.elem = lay.elem("div", {
            ...
            }), s = e.elemMain = [], o = e.elemHeader = [], y = e.elemCont = [], d = e.table = [],
            m = e.footer = lay.elem("div", {"class": D});
        if (a.zIndex && (r.style.zIndex = a.zIndex), lay.each(new Array(2), function (e) {
            ...
            }), r.insertBefore(m, r.children[0]), l.appendChild(r), s[e] = lay.elem("div", {"class": "layui-laydate-main laydate-main-list-" + e}), s[e].appendChild(t), s[e].appendChild(l), o.push(i), y.push(l), d.push(r)
        }), lay(m).html(function () {
            var e = [], t = [];
        ...
        l.thisId = a.id, e.remove(C.thisElemDate), i ? a.elem.append(r) : (t.body.appendChild(r), e.position()), e.checkDate().calendar(), e.changeEvent(), C.thisElemDate = e.elemID, "function" == typeof a.ready && a.ready(lay.extend({}, a.dateTime, {month: a.dateTime.month + 1}))
        ...
        var t = this, a = (t.config, lay.elem("div", {"class": p}));
        ...
        var t, a, n = this, i = (new Date, n.config), r = n.lang(), s = i.dateTime = i.dateTime || n.systemDate(),
            o = n.bindElem || i.elem[0], y = (n.isInput(o) ? "val" : "html", function () {
                if (n.rangeElem) {
        ...
        var i, l = this, r = l.config, s = {}, o = r[a > 41 ? "endDate" : "dateTime"], y = lay.extend({}, o, t || {});
        return lay.each({now: y, min: r.min, max: r.max}, function (e, t) {
            s[e] = l.newDate(lay.extend({year: t.year, month: t.month, date: t.date}, function () {
                var e = {};
        ...
        var a, n, i, r = this, s = r.config, o = e ? 1 : 0, d = e || s.dateTime, c = new Date, u = r.lang(),
            h = "date" !== s.type && "datetime" !== s.type, f = lay(r.table[o]).find("td"),
        ...
        if (d.year < m[0] && (d.year = m[0], r.hint(u.invalidDate)), d.year > m[1] && (d.year = m[1], r.hint(u.invalidDate)), r.firstDate || (r.firstDate = lay.extend({}, d)), c.setFullYear(d.year, d.month, 1), a = c.getDay(), n = l.getEndDate(d.month || 12, d.year), i = l.getEndDate(d.month + 1, d.year), lay.each(f, function (e, t) {
            ...
            year: d.year,
            month: d.month
        }, e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("\u65f6\u95f4", lay.extend({}, r.systemDate(), r.startTime), lay.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))) : (r.listYM = [[d.year, d.month + 1]], r.list(s.type, 0))), s.range && !e) {
            var g = r.getAsYM(d.year, d.month);
            r.calendar(lay.extend({}, d, {year: g[0], month: g[1]}))
        }
        return r.setBtnStatus(), s.range && e && !h && r.stampRange(), r
    }, C.prototype.list = function (e, t) {
        var a = this, n = a.config, i = n.dateTime, l = a.lang(),
            r = n.range && "date" !== n.type && "datetime" !== n.type, s = lay.elem("ul", {
                "class": u + " " + {
                    year: "laydate-year-list",
                    month: "laydate-month-list",
                    time: "laydate-time-list"
                }[e]
            }), o = a.elemHeader[t], m = lay(o[2]).find("span"), c = a.elemCont[t || 0], h = lay(c).find("." + u)[0],
            f = "cn" === n.lang, p = f ? "\u5e74" : "", g = a.listYM[t] || {}, v = ["hours", "minutes", "seconds"],
            D = ["startTime", "endTime"][t];
        if (g[0] < 1 && (g[0] = 1), "year" === e) {
            var C, M = C = g[0] - 7;
            M < 1 && (M = C = 1), lay.each(new Array(15), function (e) {
                var i = lay.elem("li", {"lay-ym": C}), l = {year: C};
        ...
        }), lay(m[f ? 0 : 1]).attr("lay-ym", g[0] + "-" + g[1]).html(g[0] + p); else if ("time" === e) {
            var E = function () {
                lay(s).find("ol").each(function (e, n) {
                    lay(n).find("li").each(function (n, i) {
                        a.limit(lay(i), [{hours: n}, {hours: a[D].hours, minutes: n}, {
                            hours: a[D].hours,
                            minutes: a[D].minutes,
                            seconds: n
        ...
        if (h && c.removeChild(h), c.appendChild(s), "year" === e || "month" === e) lay(a.elemMain[t]).addClass("laydate-ym-show"), lay(s).find("li").on("click", function () {
            ...
            if (!lay(this).hasClass(d)) {
                if (0 === t) i[e] = l, r && (a.startDate[e] = l), a.limit(lay(a.footer).find(T), null, 0); else if (r) a.endDate[e] = l; else {
                    var o = "year" === e ? a.getAsYM(l, g[1] - 1, "sub") : a.getAsYM(g[0], l, "sub");
                    lay.extend(i, {year: o[0], month: o[1]})
                }
            ...
            var I = lay.elem("span", {"class": w}), S = function () {
        ...
        var n, i = this, l = i.config, r = i.lang(), s = lay(i.footer).find(T);
        ...
        var a = this, n = a.config, i = lay(a.elem).find("td"), l = a.lang();
        if (e) {
        ...
        }).getTime() : 0, s = a.endDate ? a.newDate({
            year: a.endDate.year,
            month: a.endDate.month,
            date: a.endDate.date
        }).getTime() : 0;
        return s && r > s && !e ? a.hint(l.timeout) : void lay.each(i, function (n, i) {
            var l = lay(i).attr("title").split("-"), o = a.newDate({year: l[0], month: l[1] - 1, date: l[2]}).getTime();
            if (a.startDate || o === a.newDate(a.systemDate()).getTime() && lay(i).addClass(lay(i).hasClass(g) || lay(i).hasClass(v) ? "" : h), lay(i).removeClass(f + " " + y), o !== r && o !== s || lay(i).addClass(lay(i).hasClass(g) || lay(i).hasClass(v) ? f : y), "mouseenter" === e) {
                var d = a.newDate({year: t[0], month: t[1] - 1, date: t[2]}).getTime();
        ...
        var a = this, n = a.config, i = lay.extend({}, a.startDate ? lay.extend(a.startDate, a.startTime) : n.dateTime),
        ...
        var t = this, a = t.config, n = a.dateTime, i = lay(t.elem).find("td"), l = e.attr("title").split("-"),
            r = function (e) {
                new Date;
                e && lay.extend(n, l), a.range && (t.startDate ? lay.extend(t.startDate, l) : t.startDate = lay.extend({}, l, t.startTime), t.startYMD = l)
            };
        if (l = {year: 0 | l[0], month: (0 | l[1]) - 1, date: 0 | l[2]}, !e.hasClass(d)) if (a.range) {
            if (lay.each(["startTime", "endTime"], function (e, a) {
                t[a] = t[a] || {hours: 0, minutes: 0, seconds: 0}
            }), t.endState) r(), delete t.endState, delete t.endDate, t.startState = !0, i.removeClass(y + " " + f), e.addClass(y); else if (t.startState) {
        ...
        var a = this, n = a.config, i = a.lang(), l = n.dateTime, r = "static" === n.position, s = {
            datetime: function () {
        ...
        var t = this, a = t.config, n = a.dateTime, i = a.range && ("year" === a.type || "month" === a.type),
            l = t.elemCont[e || 0], r = t.listYM[e], s = function (s) {
                var o = ["startDate", "endDate"][e], y = lay(l).find(".laydate-year-list")[0],
                    d = lay(l).find(".laydate-month-list")[0];
                return y && (r[0] = s ? r[0] - 15 : r[0] + 15, t.list("year", e)), d && (s ? r[0]-- : r[0]++, t.list("month", e)), (y || d) && (lay.extend(n, {year: r[0]}), i && (t[o].year = r[0]), a.range || t.done(null, "change"), a.range || t.limit(lay(t.footer).find(T), {year: r[0]})), t.setBtnStatus(), y || d
            };
        return {
            prevYear: function () {
...
!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        link: function (t, i, n) {
            if (r.path) {
                ...
                "string" == typeof i && (n = i);
                var l = (n || t).replace(/\.|\//g, ""), f = "layuicss-" + l, c = "creating", d = 0;
        ...
        v: "3.6.0", ie: function () {
            ...
            }, s && !o.config.skin ? {skin: c + " layui-layer-hui", anim: d} : function () {
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], l.SHADE = "layui-layer-shade", l.MOVE = "layui-layer-move", s.pt.config = {
        ...
        var s = [o.innerWidth(), o.innerHeight()], f = o.find(l[1]).outerHeight() || 0,
            c = o.find("." + l[6]).outerHeight() || 0, d = function (e) {
        ...
        var e = this, t = e.config, a = i(document), s = e.layero, l = ["LAY_MOVE_DICT", "LAY_RESIZE_DICT"],
            f = s.find(t.move), c = s.find(".layui-layer-resize");
        return t.move && f.css("cursor", "move"), f.on("mousedown", function (e) {
            ...
            if (o.eventMoveElem) {
                var t = o.eventMoveElem.data(l[0]) || {}, i = t.layero, a = t.config, s = e.clientX - t.offset[0],
                    f = e.clientY - t.offset[1], c = "fixed" === i.css("position");
                if (e.preventDefault(), t.stX = c ? 0 : n.scrollLeft(), t.stY = c ? 0 : n.scrollTop(), !a.moveOut) {
                    var d = n.width() - i.outerWidth() + t.stX, u = n.height() - i.outerHeight() + t.stY;
                    s < t.stX && (s = t.stX), s > d && (s = d), f < t.stY && (f = t.stY), f > u && (f = u)
                }
                i.css({left: s, top: f})
            }
            if (o.eventResizeElem) {
                var t = o.eventResizeElem.data(l[1]) || {}, a = t.config, s = e.clientX - t.offset[0],
            ...
            if (o.eventMoveElem) {
                var t = o.eventMoveElem.data(l[0]) || {}, i = t.config;
        ...
        t.openLayer(), a.success && (2 == a.type ? n.find("iframe").on("load", function () {
            ...
            var e = i(this).index();
            if (0 === e) a.yes ? a.yes(t.index, n, t) : a.btn1 ? a.btn1(t.index, n, t) : r.close(t.index); else {
        ...
        var a = i("#" + l[0] + e), s = i("#" + l.SHADE + e), f = a.find(l[1]).outerHeight() || 0,
            c = a.attr("minLeft") || 181 * o.minIndex + "px", d = a.css("position"),
            u = {width: 180, height: f, position: "fixed", overflow: "hidden"};
    ...
    r.prompt = function (e, t) {
        ...
        var s = {};
        if (t = t || {}, t.photos) {
            var l = !("string" == typeof t.photos || t.photos instanceof i), f = l ? t.photos : {}, d = f.data || [],
                u = f.start || 0;
            ...
            if (delete t.success, l) {
                ...
                if (n || p.on("click", t.img, function () {
                    ...
                    r.photos(i.extend(t, {photos: {start: n, data: d, tab: t.tab}, full: t.full}), !0)
                }), !n) return
            }
            ...
            }, s.loadi = r.load(1, {shade: !("shade" in t) && .9, scrollbar: !1}), o(d[u].src, function (n) {
...
layui.define(["jquery", "lay"], function (e) {
    "use strict";
    var n = layui.$, t = layui.hint(), i = layui.lay;
    e("component", function (e) {
        e = e || {};
        var o = e.MOD_NAME, r = o.toUpperCase(), a = "LAY_" + r + "_MOD_INDEX", c = n.extend(!0, {
            config: e.global || {},
            ...
            var t = this, i = t.config, o = i.id || t.index;
            t.id = o, f.that[o] = t;
            var r = {
                config: i, id: o, reload: function (e) {
                    t.reload.call(t, e)
                }
            };
        ...
        return u.prototype.config = e.config, u.prototype.reload = function (e) {
            ...
            var o = this, r = o.config, f = r.elem = n(r.elem);
            if (f[0]) {
                if (f.length > 1) return layui.each(f, function () {
                    c.render(n.extend({}, r, {elem: this}))
                }), o;
            ...
            var t = this, i = t.config, r = i.elem;
            if (r) {
                var a = "LAY_" + o.toUpperCase() + "_CACHE", c = r.data(a) || {};
...
layui.define("jquery", function (e) {
    ...
    var t = layui.$, i = layui.hint(), n = {
        fixbar: function (e) {
            var i, n, o = "layui-fixbar", r = "layui-fixbar-top", a = t(document), l = t("body");
            ...
            var n = this, o = "function" == typeof t, r = new Date(e).getTime(),
                a = new Date(!t || o ? (new Date).getTime() : t).getTime(), l = r - a,
            ...
            if (null === e || "" === e) return "";
            var n = this, o = new Date(function () {
                    if (e) return isNaN(e) ? e : "string" == typeof e ? parseInt(e) : e
                }() || new Date), r = [n.digit(o.getFullYear(), 4), n.digit(o.getMonth() + 1), n.digit(o.getDate())],
            ...
            if (e = t.extend({margin: 160, duration: 200, type: "y"}, e), e.scrollElem[0] && e.thisElem[0]) {
                var i = e.scrollElem, n = e.thisElem, o = "y" === e.type, r = o ? "scrollTop" : "scrollLeft",
                    a = o ? "top" : "left", l = i[r](), c = i[o ? "height" : "width"](), g = i.offset()[a],
                    u = n.offset()[a] - g, s = {};
            ...
            return o = o || "click", "object" == typeof e ? e.on(o, function () {
                var e = t(this), n = e.attr("lay-event");
...
layui.define("layer", function (e) {
    ...
    var t = layui.$, i = layui.layer, n = layui.hint(), o = layui.device(), a = {
        ...
        }, l = "upload", u = "layui-upload-file", c = "layui-upload-form", f = "layui-upload-iframe",
    ...
    p.prototype.config = {
        ...
        var n, a = this, r = a.config, l = a.elemFile[0], u = function () {
            var i = 0, n = 0, o = e || a.files || a.chooseFiles || l.files, u = function () {
        ...
        if (v = 0 === v.length ? l.value.match(/[^\/\\]+\..+/g) || [] || "" : v, 0 !== v.length) {
            ...
            if (a.fileLength = function () {
                var t = 0, i = e || a.files || a.chooseFiles || l.files;
        ...
        i.elem.off("upload.start").on("upload.start", function () {
            ...
            var l = t(this), u = o.originalEvent.dataTransfer.files || [];
...
layui.define(["jquery", "laytpl", "lay", "component"], function (e) {
    "use strict";
    var i = layui.$, t = layui.laytpl, n = (layui.hint(), layui.device()), a = n.mobile ? "click" : "mousedown",
        l = layui.component({
            MOD_NAME: "dropdown",
            config: {
                trigger: "click",
            ...
            render: function (e) {
                var n = this, r = n.config, m = i("body"), s = function () {
                        ...
                        return layui.each(n, function (n, a) {
                            ...
                            if ("-" === s || a.title || a.id || o) {
                                ...
                                if (T.data("item", a), o) {
                                    var c = i('<div class="layui-panel layui-menu-body-panel"></div>'), p = i("<ul></ul>");
                ...
                ("contextmenu" === r.trigger || lay.isTopElem(r.elem[0])) && (e = !0), n.elemView = i(T), n.elemView.append(r.content || s()), r.className && n.elemView.addClass(r.className), r.style && n.elemView.attr("style", r.style), r.component && n.elemView.attr("lay-component", r.component), l.thisId = r.id, n.remove(), m.append(n.elemView), r.elem.data(l.CONST.MOD_INDEX + "_opened", !0), n.position(), o.prevElem = n.elemView, o.prevElem.data("prevElem", r.elem), n.elemView.find(".layui-menu").on(a, function (e) {
                    ...
                    var t = i(this), a = t.data("item") || {}, l = a.child && a.child.length > 0;
                    ...
                    var t = i(this), n = t.parent(), a = n.data("item") || {};
        ...
        }), o = {}, r = l.Class, u = "." + l.CONST.STR_ITEM_GROUP + ">." + l.CONST.STR_MENU_TITLE;
    r.prototype.position = function (e) {
        ...
        var e = this, i = e.config, t = o.prevElem;
        ...
        t.on("click", n, function (e) {
            var t = i(this), n = t.parents(".layui-menu").eq(0),
                a = t.hasClass(l.CONST.STR_ITEM_GROUP) || t.hasClass(l.CONST.STR_ITEM_PARENT),
                o = n.attr("lay-filter") || n.attr("id"), r = lay.options(this);
            ...
            var t = i(this), n = t.parents("." + l.CONST.STR_ITEM_GROUP + ":eq(0)"), a = lay.options(n[0]);
            "isAllowSpread" in a && !a.isAllowSpread || o.spread(n)
        });
        var r = ".layui-menu ." + l.CONST.STR_ITEM_PARENT;
        t.on("mouseenter", r, function (t) {
            var n = i(this), a = n.find("." + l.CONST.STR_MENU_PANEL);
            if (a[0]) {
            ...
            var t = i(this), n = t.children("." + l.CONST.STR_MENU_PANEL);
...
layui.define("layer", function (e) {
        ...
        var n = this, u = n.config, d = t(r + function () {
            ...
            input: function () {
                ...
                u.autocomplete && e.attr("autocomplete", u.autocomplete), d.find("input[lay-affix],textarea[lay-affix]").each(function () {
                    var e = t(this), i = e.attr("lay-affix"), a = "layui-input-suffix", n = e.next("." + a),
                        r = function (e, i) {
                            ...
                            clear: [function () {
                                ...
                                var t = "LAY_FORM_INPUT_AFFIX_SHOW", i = e.data(t);
                ...
                var e, i = "\u8bf7\u9009\u62e9", a = "layui-form-select", n = "layui-select-title",
                    r = "layui-select-none", u = "", f = d.find("select"), v = function (i, l) {
                        ...
                        var y, p = t(this), m = i.find("." + n), x = m.find("input"), g = i.find("dl"),
                            k = g.children("dd"), b = this.selectedIndex;
                        if (!d) {
                            var C = function () {
                                ...
                                var i = function (t, a) {
                                    ...
                                    var r = function () {
                                        ...
                                        if (g.children("dd." + s)[0] && "next" === t) {
                                            var i = g.children("dd:not(." + s + ",." + c + ")"), n = i.eq(0).index();
    ...
    var d = u.prototype.submit = function (e, a) {
        var o = t(this), s = "string" == typeof e ? e : o.attr("lay-filter"),
            c = this.getFormElem ? this.getFormElem(s) : o.parents(r).eq(0), u = c.find("*[lay-verify]"), d = null,
            h = f.config.verify, y = "layui-form-danger", p = {};
        if (layui.each(u, function (e, a) {
            var l = t(this), r = l.attr("lay-verify").split("|"), o = l.attr("lay-verType"), s = l.val();
            if (l.removeClass(y), layui.each(r, function (e, t) {
                var r, c = "", u = "function" == typeof h[t];
                if (h[t]) {
...
layui.define(["laypage", "component", "dropdown", "form", "util"], function (i) {
    "use strict";
    var e = layui.$, l = (layui.hint(), layui.laypage), t = layui.dropdown, c = layui.form, n = layui.util,
        o = layui.component({
            MOD_NAME: "icon",
            config: {type: "fontclass", fontfamily: "layui-icon", replace: !0, isSplit: !1, search: !0, page: !0},
            CONST: {
            ...
            render: function (i) {
                var l = this, n = l.config, a = n.elem,
    ...
    a.prototype.renderIcon = function (i) {
        ...
        var e = this, l = e.config, t = [];
        i = (i || "").toLowerCase(), layui.each(l.data, function (e, c) {
            try {
                var n = c.fontclass.toLowerCase(), o = c.unicode.toLowerCase(), a = c.title.toLowerCase();
        ...
        var l = this, t = l.config, a = i.find("." + o.CONST.search + " input"), s = a.attr("lay-filter");
        i.find("." + o.CONST.list).on("click", "li", function () {
            var i = e(this), c = i.index(), a = l.thisData[c] || {};
        ...
        unicode: "&#xe68f;"
    }, {title: "\u7a7a\u5fc3", fontclass: "layui-icon-heart", unicode: "&#xe68c;"}, {
        title: "\u4eae\u5ea6/\u6674",
        fontclass: "layui-icon-light",
        unicode: "&#xe748;"
    }, {title: "\u65f6\u95f4/\u5386\u53f2", fontclass: "layui-icon-time", unicode: "&#xe68d;"}, {
        title: "\u84dd\u7259",
        fontclass: "layui-icon-bluetooth",
        unicode: "&#xe689;"
    }, {title: "@\u827e\u7279", fontclass: "layui-icon-at", unicode: "&#xe687;"}, {
        title: "\u9759\u97f3",
        ...
        unicode: "&#xe683;"
    }, {title: "\u793c\u7269/\u6d3b\u52a8", fontclass: "layui-icon-gift", unicode: "&#xe627;"}, {
        title: "\u90ae\u7bb1",
        fontclass: "layui-icon-email",
        unicode: "&#xe618;"
    }, {title: "RSS", fontclass: "layui-icon-rss", unicode: "&#xe808;"}, {
        title: "WiFi",
        ...
        unicode: "&#xe67f;"
    }, {title: "\u7a7f\u68ad\u6846", fontclass: "layui-icon-transfer", unicode: "&#xe691;"}, {
        title: "\u5ba2\u670d",
        fontclass: "layui-icon-service",
        unicode: "&#xe626;"
    }, {title: "\u51cf", fontclass: "layui-icon-subtraction", unicode: "&#xe67e;"}, {
        title: "\u52a0",
        fontclass: "layui-icon-addition",
        unicode: "&#xe624;"
    }, {title: "\u6ed1\u5757", fontclass: "layui-icon-slider", unicode: "&#xe714;"}, {
        title: "\u6253\u5370",
        fontclass: "layui-icon-print",
        unicode: "&#xe66d;"
    }, {title: "\u5bfc\u51fa", fontclass: "layui-icon-export", unicode: "&#xe67d;"}, {
        title: "\u5217",
        ...
        unicode: "&#xe758;"
    }, {title: "\u5168\u5c4f", fontclass: "layui-icon-screen-full", unicode: "&#xe622;"}, {
        title: "\u534a\u661f",
        ...
        unicode: "&#xe67a;"
    }, {title: "\u624b\u673a", fontclass: "layui-icon-cellphone", unicode: "&#xe678;"}, {
        title: "\u9a8c\u8bc1\u7801",
        fontclass: "layui-icon-vercode",
        unicode: "&#xe679;"
    }, {title: "\u5fae\u4fe1", fontclass: "layui-icon-login-wechat", unicode: "&#xe677;"}, {
        title: "QQ",
        fontclass: "layui-icon-login-qq",
        unicode: "&#xe676;"
    }, {title: "\u5fae\u535a", fontclass: "layui-icon-login-weibo", unicode: "&#xe675;"}, {
        title: "\u5bc6\u7801",
        ...
        unicode: "&#xe66f;"
    }, {title: "\u5237\u65b0-\u7c97", fontclass: "layui-icon-refresh-3", unicode: "&#xe9aa;"}, {
        title: "\u6388\u6743",
        ...
        unicode: "&#xe6b1;"
    }, {title: "\u63d0\u793a\u8bf4\u660e", fontclass: "layui-icon-tips", unicode: "&#xe702;"}, {
        title: "\u4fbf\u7b7e",
        fontclass: "layui-icon-note",
        unicode: "&#xe66e;"
    }, {title: "\u4e3b\u9875", fontclass: "layui-icon-home", unicode: "&#xe68e;"}, {
        title: "\u9ad8\u7ea7",
        fontclass: "layui-icon-senior",
        unicode: "&#xe674;"
    }, {title: "\u5237\u65b0", fontclass: "layui-icon-refresh", unicode: "&#xe669;"}, {
        title: "\u5237\u65b0",
        fontclass: "layui-icon-refresh-1",
        unicode: "&#xe666;"
    }, {title: "\u65d7\u5e1c", fontclass: "layui-icon-flag", unicode: "&#xe66c;"}, {
        title: "\u4e3b\u9898",
        ...
        unicode: "&#xe667;"
    }, {title: "\u7f51\u7ad9", fontclass: "layui-icon-website", unicode: "&#xe7ae;"}, {
        title: "\u63a7\u5236\u53f0",
        ...
        unicode: "&#xe664;"
    }, {title: "\u8bbe\u7f6e-\u7a7a\u5fc3", fontclass: "layui-icon-set", unicode: "&#xe716;"}, {
        title: "\u6a21\u677f",
        fontclass: "layui-icon-template-1",
        unicode: "&#xe656;"
    }, {title: "\u5e94\u7528", fontclass: "layui-icon-app", unicode: "&#xe653;"}, {
        title: "\u6a21\u677f",
        fontclass: "layui-icon-template",
        unicode: "&#xe663;"
    }, {title: "\u8d5e", fontclass: "layui-icon-praise", unicode: "&#xe6c6;"}, {
        title: "\u8e29",
        fontclass: "layui-icon-tread",
        unicode: "&#xe6c5;"
    }, {title: "\u7537", fontclass: "layui-icon-male", unicode: "&#xe662;"}, {
        title: "\u5973",
        ...
        unicode: "&#xe659;"
    }, {title: "\u94bb\u77f3-\u7b49\u7ea7", fontclass: "layui-icon-diamond", unicode: "&#xe735;"}, {
        title: "\u706b",
        ...
        unicode: "&#xe715;"
    }, {title: "\u529e\u516c-\u9605\u8bfb", fontclass: "layui-icon-read", unicode: "&#xe705;"}, {
        title: "\u8c03\u67e5",
        ...
        unicode: "&#xe698;"
    }, {title: "\u8d2d\u7269\u8f66", fontclass: "layui-icon-cart", unicode: "&#xe657;"}, {
        title: "\u4e0b\u4e00\u9875",
        ...
        unicode: "&#xe601;"
    }, {title: "\u7ec4\u4ef6", fontclass: "layui-icon-component", unicode: "&#xe857;"}, {
        title: "\u6587\u4ef6-\u7c97",
        fontclass: "layui-icon-file-b",
        unicode: "&#xe655;"
    }, {title: "\u7528\u6237", fontclass: "layui-icon-user", unicode: "&#xe770;"}, {
        title: "\u53d1\u73b0-\u5b9e\u5fc3",
        fontclass: "layui-icon-find-fill",
        unicode: "&#xe670;"
    }, {title: "loading", fontclass: "layui-icon-loading", unicode: "&#xe63d;"}, {
        title: "loading",
        fontclass: "layui-icon-loading-1",
        unicode: "&#xe63e;"
    }, {title: "\u6dfb\u52a0", fontclass: "layui-icon-add-1", unicode: "&#xe654;"}, {
        title: "\u64ad\u653e",
        fontclass: "layui-icon-play",
        unicode: "&#xe652;"
    }, {title: "\u6682\u505c", fontclass: "layui-icon-pause", unicode: "&#xe651;"}, {
        title: "\u97f3\u9891-\u8033\u673a",
        fontclass: "layui-icon-headset",
        unicode: "&#xe6fc;"
    }, {title: "\u89c6\u9891", fontclass: "layui-icon-video", unicode: "&#xe6ed;"}, {
        title: "\u8bed\u97f3-\u58f0\u97f3",
        ...
        unicode: "&#xe645;"
    }, {title: "\u5220\u9664\u7ebf", fontclass: "layui-icon-fonts-del", unicode: "&#xe64f;"}, {
        title: "\u4ee3\u7801",
        fontclass: "layui-icon-fonts-code",
        unicode: "&#xe64e;"
    }, {title: "HTML", fontclass: "layui-icon-fonts-html", unicode: "&#xe64b;"}, {
        title: "\u5b57\u4f53\u52a0\u7c97",
        fontclass: "layui-icon-fonts-strong",
        unicode: "&#xe62b;"
    }, {title: "\u5220\u9664\u94fe\u63a5", fontclass: "layui-icon-unlink", unicode: "&#xe64d;"}, {
        title: "\u56fe\u7247",
        fontclass: "layui-icon-picture",
        unicode: "&#xe64a;"
    }, {title: "\u94fe\u63a5", fontclass: "layui-icon-link", unicode: "&#xe64c;"}, {
        title: "\u8868\u60c5-\u7b11-\u7c97",
        ...
        unicode: "&#xe63f;"
    }, {title: "\u7f16\u8f91", fontclass: "layui-icon-edit", unicode: "&#xe642;"}, {
        title: "\u5206\u4eab",
        fontclass: "layui-icon-share",
        unicode: "&#xe641;"
    }, {title: "\u5220\u9664", fontclass: "layui-icon-delete", unicode: "&#xe640;"}, {
        title: "\u8868\u5355",
        ...
        unicode: "&#xe639;"
    }, {title: "\u7a97\u53e3", fontclass: "layui-icon-layer", unicode: "&#xe638;"}, {
        title: "\u65e5\u671f",
        ...
        unicode: "&#xe634;"
    }, {title: "\u7ffb\u9875", fontclass: "layui-icon-prev-circle", unicode: "&#xe633;"}, {
        title: "\u5e03\u5c40",
        fontclass: "layui-icon-layouts",
        unicode: "&#xe632;"
    }, {title: "\u5de5\u5177", fontclass: "layui-icon-util", unicode: "&#xe631;"}, {
        title: "\u9009\u62e9\u6a21\u677f",
        ...
        unicode: "&#xe62f;"
    }, {title: "\u6811", fontclass: "layui-icon-tree", unicode: "&#xe62e;"}, {
        title: "\u8868\u683c",
        ...
        unicode: "&#xe629;"
    }, {title: "\u5f15\u64ce", fontclass: "layui-icon-engine", unicode: "&#xe628;"}, {
        title: "\u4e0b\u4e09\u89d2",
        fontclass: "layui-icon-triangle-d",
        unicode: "&#xe625;"
    }, {title: "\u53f3\u4e09\u89d2", fontclass: "layui-icon-triangle-r", unicode: "&#xe623;"}, {
        title: "\u6587\u4ef6",
        ...
        unicode: "&#xe616;"
    }, {title: "\u6dfb\u52a0-\u5706\u5708", fontclass: "layui-icon-add-circle", unicode: "&#xe61f;"}, {
        title: "404",
        fontclass: "layui-icon-404",
        unicode: "&#xe61c;"
    }, {title: "\u5173\u4e8e", fontclass: "layui-icon-about", unicode: "&#xe60b;"}, {
        title: "\u7bad\u5934 \u5411\u4e0a",
        ...
        unicode: "&#xe603;"
    }, {title: "\u7bad\u5934 \u5411\u53f3", fontclass: "layui-icon-right", unicode: "&#xe602;"}, {
        title: "\u5706\u70b9",
        ...
        unicode: "&#xe614;"
    }, {title: "\u7fa4\u7ec4", fontclass: "layui-icon-group", unicode: "&#xe613;"}, {
        title: "\u597d\u53cb",
        ...
        unicode: "&#xe60f;"
    }, {title: "\u8bb0\u5f55", fontclass: "layui-icon-log", unicode: "&#xe60e;"}, {
        title: "\u56fe\u7247-\u7ec6\u4f53",
        ...
        unicode: "&#xe609;"
    }, {title: "\u5bf9 OK", fontclass: "layui-icon-ok", unicode: "&#xe605;"}, {
        title: "\u5e2e\u52a9",
        fontclass: "layui-icon-help",
        unicode: "&#xe607;"
    }, {title: "\u5ba2\u670d", fontclass: "layui-icon-chat", unicode: "&#xe606;"}, {
        title: "top \u7f6e\u9876",
        ...
        unicode: "&#x1007;"
    }, {title: "\u5173\u95ed-\u7a7a\u5fc3", fontclass: "layui-icon-close", unicode: "&#x1006;"}, {
        title: "\u6b63\u786e",
...
layui.define(["laypage", "component", "dropdown", "form", "util"], function (t) {
    "use strict";
    var e = layui.$, l = (layui.hint(), layui.laypage, layui.dropdown), i = layui.form, a = layui.util,
        n = layui.component({
            MOD_NAME: "keyboard",
            config: {type: "normal", isHeader: !0, title: "", style: "", keyStyle: "", single: !1, setData: {}},
            CONST: {
                elem: "layui-keyboard",
    ...
    c.prototype.getValue = function (t) {
        ...
        var l = this, i = l.config, c = t.find("." + n.CONST.header), s = {
            options: i, render: function () {
                l.renderData()
            }
        };
        t.find("." + n.CONST.list).on("click", "li", function () {
            var t = e(this), a = t.data("index"), c = i.data[a] || {}, r = c.type, y = l.getValue(c), u = function (t) {
                t = t || y, i.single ? i.elem.val(t) : lay(i.elem[0]).insertVal(t)
            }, d = e.extend({keyData: c, keyElem: t, setValue: u}, s);
    ...
    var o = c.prototype.fnKey = {
        br: {type: "br"},
        backspace: {
            title: '<i class="layui-icon layui-icon-backspace"></i>', type: "backspace", click: function (t) {
                var e = t.options, l = e.elem;
                l.val(), t.keyData;
                lay(l[0]).deleteVal()
            }
        },
        decimal: {
            title: ".", type: "decimal", style: "font-weight: 700;", click: function (t) {
                var e = t.options, l = e.elem, i = l.val(), a = t.keyData;
                if ("number" === e.type) {
        ...
        caps: {
            title: "Caps", value: "caps", type: "caps", style: "width: 65px;", selectedCall: function (t, e) {
        ...
        space: {title: "space", type: "space", value: " ", style: "width: 135px;"}
    };
    c.prototype.data = {
        normal: [{title: "1"}, {title: "2"}, {title: "3"}, {title: "4"}, {title: "5"}, {title: "6"}, {title: "7"}, {title: "8"}, {title: "9"}, {title: "0"}, o.backspace, o.br, o.decimal, {title: "q"}, {title: "w"}, {title: "e"}, {title: "r"}, {title: "t"}, {title: "y"}, {title: "u"}, {title: "i"}, {title: "o"}, {title: "p"}, o.br, o.caps, {title: "a"}, {title: "s"}, {title: "d"}, {title: "f"}, {title: "g"}, {title: "h"}, {title: "j"}, {title: "k"}, {title: "l"}, o.br, {title: "z"}, {title: "x"}, {title: "c"}, {title: "v"}, {title: "b"}, {title: "n"}, {title: "m"}, o.space],
        letter: [{title: "q"}, {title: "w"}, {title: "e"}, {title: "r"}, {title: "t"}, {title: "y"}, {title: "u"}, {title: "i"}, {title: "o"}, {title: "p"}, o.br, e.extend({}, o.caps, {
            title: "\u2191",
            style: null
        }), {title: "a"}, {title: "s"}, {title: "d"}, {title: "f"}, {title: "g"}, {title: "h"}, {title: "j"}, {title: "k"}, {title: "l"}, o.br, {title: "z"}, {title: "x"}, {title: "c"}, {title: "v"}, {title: "b"}, {title: "n"}, {title: "m"}, e.extend({}, o.backspace, {style: "width: 100px;"})],
        number: [{title: "1"}, {title: "2"}, {title: "3"}, o.br, {title: "4"}, {title: "5"}, {title: "6"}, o.br, {title: "7"}, {title: "8"}, {title: "9"}, o.br, {title: "0"}, o.decimal, o.backspace],
        province: [{title: "\u4eac"}, {title: "\u6d25"}, {title: "\u5180"}, {title: "\u664b"}, {title: "\u8499"}, {title: "\u8fbd"}, {title: "\u5409"}, {title: "\u9ed1"}, o.br, {title: "\u6caa"}, {title: "\u82cf"}, {title: "\u6d59"}, {title: "\u7696"}, {title: "\u95fd"}, {title: "\u8d63"}, {title: "\u9c81"}, {title: "\u8c6b"}, o.br, {title: "\u9102"}, {title: "\u6e58"}, {title: "\u7ca4"}, {title: "\u6842"}, {title: "\u743c"}, {title: "\u5ddd"}, {title: "\u8d35"}, {title: "\u4e91"}, o.br, {title: "\u6e1d"}, {title: "\u85cf"}, {title: "\u9655"}, {title: "\u7518"}, {title: "\u9752"}, {title: "\u5b81"}, {title: "\u65b0"}, o.backspace]
    }, c.prototype.initData = {
        normal: {title: "\u9009\u62e9\u952e", style: "min-width: 400px;"},
        letter: {title: "\u5b57\u6bcd\u952e", style: "min-width: 365px;"},
        number: {title: "\u6570\u5b57\u952e", style: "min-width: 225px;", keyStyle: "width: 65px;"},
        province: {title: "\u9009\u62e9\u7701\u4efd", style: "min-width: 345px;", keyStyle: "width: 36px;", single: !0}
...
layui.define(["lay", "laytpl", "laypage", "layer", "form", "util"], function (e) {
    "use strict";
    var t = layui.$, a = (layui.lay, layui.laytpl), i = layui.laypage, l = layui.layer, n = layui.form, o = layui.util,
        r = layui.hint(), d = layui.device(), c = {
            ...
            var e = this, t = e.config, a = t.id || t.index;
            return a && (s.that[a] = e, s.config[a] = t), {
                config: t, reload: function (t, a) {
                    e.reload.call(e, t, a)
        ...
        }, h = "table", f = ".layui-table", p = "layui-hide", v = "layui-hide-v", m = "layui-none", g = "layui-table-view",
        b = ".layui-table-tool", x = ".layui-table-box", k = ".layui-table-init", C = ".layui-table-header",
        w = ".layui-table-body", T = ".layui-table-main", N = ".layui-table-fixed", L = ".layui-table-fixed-l",
        _ = ".layui-table-fixed-r", S = ".layui-table-total", A = ".layui-table-page", R = ".layui-table-sort",
        W = "layui-table-edit", z = "layui-table-hover", E = function (e) {
        ...
        I = t(window), H = t(document), D = function (e) {
            var a = this;
    ...
    D.prototype.config = {
        ...
        var n = l.elem, o = n.next("." + g), r = i.elem = t(a(F).render({VIEW_CLASS: g, data: l, index: i.index}));
        ...
        var t = this, a = (t.config, {checkbox: 48, radio: 48, space: 15, numbers: 40});
        ...
        if ("default" === i.toolbar) n.html(l); else if ("string" == typeof i.toolbar) {
        ...
        var e = this, i = e.config, l = e.layPagebar = t('<div class="layui-inline layui-table-pagebar"></div>');
        if (i.pagebar) {
            var n = t(i.pagebar).html() || "";
            n && l.append(a(n).render(i)), e.layPage.append(l)
        }
    }, D.prototype.setParentCol = function (e, t) {
        var a = this, i = a.config, l = a.layHeader.find('th[data-key="' + i.index + "-" + t + '"]'),
            n = parseInt(l.attr("colspan")) || 0;
        if (l[0]) {
            var o = t.split("-"), r = i.cols[o[0]][o[1]];
        ...
        var e = this, t = e.config, a = 0, i = 0, l = 0, n = 0, o = e.setInit("width");
        ...
        var a = this, i = a.layMain.find("." + m), l = t('<div class="' + m + '">' + (e || "Error") + "</div>");
        ...
        var a = this, i = a.config, l = i.request, n = i.response, o = function () {
        ...
        var d = this, s = d.config, u = e[s.response.dataName] || [], h = e[s.response.totalRowName], f = [], g = [],
            b = [], x = function () {
                var e;
                return !r && d.sortKey ? d.sort(d.sortKey.field, d.sortKey.sort, !0) : (layui.each(u, function (i, l) {
                    var o = [], h = [], v = [], m = i + s.limit * (n - 1) + 1;
                    if ("object" != typeof l) {
                        u[i] = l = {LAY_KEY: l};
                        try {
                            c.cache[d.key][i] = l
                    ...
                    "array" === layui._typeof(l) && 0 === l.length || (r || (l[c.config.indexName] = i), d.eachCols(function (n, r) {
                        var u = r.field || n, f = s.index + "-" + r.key, g = l[u];
                        if (void 0 !== g && null !== g || (g = ""), !r.colGroup) {
                            var b = ['<td data-field="' + u + '" data-key="' + f + '" ' + function () {
                                ...
                                var n = t.extend(!0, {LAY_INDEX: m, LAY_COL: r}, l), o = c.config.checkName;
                                switch (r.type) {
                                    case"checkbox":
        ...
        if (n.totalRow) {
            ...
            l.eachCols(function (e, d) {
                var c = d.field || e, s = function () {
                    var e, t = d.totalRowText || "", a = parseFloat(o[c]).toFixed(2), n = {};
                    ...
                    return "string" == typeof e ? a(e).render(t.extend({TOTAL_NUMS: s}, d)) : s
                }(), "</div></td>"].join("");
        ...
        var t = this, a = (t.config, t.elem.attr("lay-filter"));
        n.render(e, a)
    }, D.prototype.setThisRowChecked = function (e) {
        var t = this, a = (t.config, "layui-table-click"), i = t.layBody.find('tr[data-index="' + e + '"]');
        ...
        var a = this, i = a.config, l = c.cache[a.key];
        l[e] && "array" !== layui._typeof(l[e]) && (l[e][i.checkName] = t)
    }, D.prototype.syncCheckAll = function () {
        var e = this, t = e.config, a = e.layHeader.find('input[name="layTableCheckbox"]'), i = function (a) {
        ...
        var a = this, i = a.elem.find("style")[0], l = i.sheet || i.styleSheet || {}, n = l.cssRules || l.rules;
        layui.each(n, function (a, i) {
            if (i.selectorText === ".laytable-cell-" + e) return t(i), !0
        })
    }, D.prototype.fullSize = function () {
        var e, t = this, a = t.config, i = a.height;
        ...
        var e = this, a = e.layMain.children("table"), i = e.layMain.width() - e.layMain.prop("clientWidth"),
            l = e.layMain.height() - e.layMain.prop("clientHeight"),
            n = (e.getScrollWidth(e.layMain[0]), a.outerWidth() - e.layMain.width()), o = function (e) {
                if (i && l) {
                    if (e = e.eq(0), !e.find(".layui-table-patch")[0]) {
                        var a = t('<th class="layui-table-patch"><div class="layui-table-cell"></div></th>');
                        a.find("div").css({width: i}), e.find("tr").append(a)
                    }
        ...
        var e, a = this, i = a.config, o = t("body"), r = {}, s = a.layHeader.find("th"), u = ".layui-table-cell",
        ...
        a.layTool.on("click", "*[lay-event]", function (e) {
            ...
            layui.event.call(this, h, "toolbar(" + f + ")", t.extend({event: r, config: i}, {}))
        }), a.layPagebar.on("click", "*[lay-event]", function (e) {
            var a = t(this), l = a.attr("lay-event");
            layui.event.call(this, h, "pagebar(" + f + ")", t.extend({event: l, config: i}, {}))
        }), s.on("mousemove", function (e) {
            var a = t(this), i = a.offset().left, l = e.clientX - i;
            ...
            var l, n = t(this), o = n.find(R), r = o.attr("lay-sort");
        ...
        var v = function (e) {
            var i = t(this), l = i.parents("tr").eq(0).data("index"), n = a.layBody.find('tr[data-index="' + l + '"]'),
                o = c.cache[a.key] || [];
                ...
                tr: n, data: c.clearCacheKey(o), del: function () {
                    ...
                    e = e || {}, layui.each(e, function (e, t) {
                        if (e in o) {
                            ...
                            }), l.children(u).html(y.call(a, {templet: i}, t, o)), l.data("content", t)
                        }
                    })
                }
            }, e)
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            ...
            var e = t(this).prev(), l = e[0].checked, n = c.cache[a.key], o = e.parents("tr").eq(0).data("index");
            layui.each(n, function (e, t) {
                o === e ? t[i.checkName] = !0 : delete t[i.checkName]
            }), a.setThisRowChecked(o), layui.event.call(this, h, "radio(" + f + ")", v.call(this, {checked: l}))
        ...
        a.layBody.on("change", "." + W, function () {
            var e = t(this), i = this.value, l = e.parent().data("field"), n = e.parents("tr").eq(0).data("index"),
                o = c.cache[a.key][n];
            o[l] = i, layui.event.call(this, h, "edit(" + f + ")", v.call(this, {value: i, field: l}))
        }).on("blur", "." + W, function () {
            var e, i = t(this), l = this, n = i.parent().data("field"), o = i.parents("tr").eq(0).data("index"),
                r = c.cache[a.key][o];
            a.eachCols(function (t, a) {
                a.field == n && a.templet && (e = a.templet)
            }), i.siblings(u).html(function (t) {
                return y.call(a, {templet: e}, t, r)
            }(l.value)), i.parent().data("content", l.value), i.remove()
        }), a.layBody.on("click", "td", function (e) {
            var a = t(this), i = (a.data("field"), a.data("edit")), l = a.children(u);
            if (!a.data("off") && i) {
        ...
        var g = "layui-table-grid-down", b = function (e) {
            var a = t(this), i = a.children(u);
            if (!a.data("off")) if (e) a.find(".layui-table-grid-down").remove(); else if (i.prop("scrollWidth") > i.outerWidth()) {
        ...
        a.layBody.on("click", "." + g, function (e) {
            ...
            layui.event.call(this, h, "tool(" + f + ")", v.call(this, {event: e.attr("lay-event")})), a.setThisRowChecked(i)
        ...
        a = a || {};
        var i = this, l = t(e ? 'table[lay-filter="' + e + '"]' : f + "[lay-data]"),
            n = "Table element property lay-data configuration item has a syntax error: ";
        return l.each(function () {
            var i = t(this), l = i.attr("lay-data");
            try {
        ...
        var l = s.that[e], n = s.config[e] || {}, o = {csv: "text/csv", xls: "application/vnd.ms-excel"}[a],
...
layui.define("jquery", function (e) {
    "use strict";
    var n = layui.$, i = (layui.hint(), layui.device(), {
            config: {}, set: function (e) {
                var i = this;
    ...
    m.prototype.config = {
        ...
        var e = this, n = e.config, i = n.index - 1;
        ...
        i.elem.attr("lay-arrow", i.arrow), i.elem.find("." + u)[0] && i.elem.find("." + u).remove(), i.elem.append(t), t.on("click", function () {
            var i = n(this), t = i.attr("lay-type");
            e.slide(t)
        })
    }, m.prototype.indicator = function () {
        var e = this, i = e.config, t = e.elemInd = n(['<div class="' + c + '"><ul>', function () {
            var n = [];
        ...
        if (!i.haveSlide) {
            ...
            var f = {index: u.index, prevIndex: c, item: l.eq(u.index)};
...
layui.define(["layer", "form"], function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        i = i || {};
        var a = this, n = a.config, r = "layui-layedit", s = e("string" == typeof t ? "#" + t : t),
            u = "LAY_layedit_" + ++a.index, d = s.next("." + r), y = e.extend({}, n, i), f = function () {
                var t = [], e = {};
